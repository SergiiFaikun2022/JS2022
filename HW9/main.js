...
//     person.innerText= `${simpson.name}  ${simpson.surname}  ${simpson.age}`
...
// ];
//
// let targets = document.getElementsByClassName('target1');
// let target = targets[0];
//
// for (const student of coursesArray) {
//
//     let tittle = document.createElement('div');
//     tittle.classList.add('tittle');
//     tittle.innerText = student.title;
//     target.appendChild(tittle);
//
//     let monthDuration = document.createElement('div');
//     monthDuration.classList.add('monthDuration');
//     monthDuration.innerText = student.monthDuration;
//     target.appendChild(monthDuration);
//
//     let hourDuration = document.createElement('div');
//     hourDuration.classList.add('hourDuration');
//     hourDuration.innerText = student.hourDuration;
//     target.appendChild(hourDuration);
//
//
//
...
//
//     for (const moduleElement of student.modules) {
...
// mainBlock.classList.add('collapse');
// mainBlock.classList.add('alpha');
// mainBlock.classList.add('beta');
// mainBlock.innerText = 'Hello';
// mainBlock.style.color = 'red';
// mainBlock.style.background = 'blue';
// document.body.appendChild(mainBlock);
// document.body.appendChild(mainBlock.cloneNode(true));
//
